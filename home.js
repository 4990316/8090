...
var MAC={
	...
	'Lazyload': function() {
			//$.getScript("https://cdn.jsdelivr.net/npm/jquery-lazyload@1.9.7/jquery.lazyload.js", function() {
			$.getScript("https://cdn.jsdelivr.net/npm/jquery-lazyload@1.9.7/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					placeholder : maccms.css+"img/load.jpg",
					effect: "fadeIn",
					threshold: 300,
					failurelimit: 15,
    ...
    'Verify': {
        ...
        'Refresh':function(){
            $('.fed-comm-code').attr('src', maccms.path +'/index.php/verify/index.html?r='+Math.random());
        },
        'Show':function(){
    ...
    'Gbook':{
        ...
        'Report':function(name){
            MAC.Pop.Show(400,300,'数据报错',maccms.path+'/index.php/gbook/report.html?name=' + encodeURIComponent(name),function($r){
